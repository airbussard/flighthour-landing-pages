...
export default function HeroSectionBusiness() {
  return (
    <section className="relative h-[400px] md:h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container-section relative z-10">
        ...
        >
          ...
          >
            Das <span className="text-flighthour-yellow drop-shadow-2xl">außergewöhnliche</span>
            <br className="hidden sm:block" />
            <span className="block sm:inline">Teamevent</span>
          </motion.h1>
          ...
          >
            Stärken Sie Ihren Teamgeist im professionellen Flugsimulator.
            <br className="hidden md:block" />
            <span className="block md:inline">Perfekt für Teams von 5 bis 50+ Personen!</span>
          </motion.p>
          ...
          >
            <Link 
              ...
              className="btn-primary text-base sm:text-lg py-4 sm:py-3"
            >
              Anfrage stellen
            </Link>
            <Link href="#pakete" className="btn-secondary text-base sm:text-lg py-4 sm:py-3">
              Pakete ansehen
            </Link>
          </motion.div>
        </motion.div>
