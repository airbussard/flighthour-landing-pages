  ...
  const faqs = [
    {
      ...
      answer:
        'Nach der Bestellung erhältst du einen personalisierten Geschenkgutschein als PDF. Dieser kann ausgedruckt oder digital verschenkt werden. Der Beschenkte kann dann flexibel einen Termin seiner Wahl buchen.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Nein, absolut nicht! Unsere erfahrenen Instruktoren passen sich jedem Niveau an und führen Schritt für Schritt durch das Erlebnis.',
    },
    {
      question: 'Kann ich das Paket nachträglich upgraden?',
      answer:
        'Ja, ein Upgrade ist jederzeit möglich. Der Beschenkte zahlt bei der Buchung einfach die Differenz zum gewünschten Paket.',
    },
    {
      question: 'Was passiert bei Flugangst?',
      answer:
        'Kein Problem! Der Flugsimulator ist komplett sicher und am Boden. Viele Menschen mit Flugangst nutzen ihn sogar, um ihre Ängste zu überwinden. Die Tür bleibt immer offen.',
    },
  ]
    ...
    <section id="faq" className="py-20 bg-gray-50" ref={ref}>
      <div className="container-section max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600">Alles was du über Geschenkgutscheine wissen musst</p>
        </motion.div>
