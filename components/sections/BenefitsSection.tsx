...
export default function BenefitsSection() {
  ...
  const benefits = [
    ...
    },
    {
      icon: '✈️',
      title: '100% Sicher',
      description: 'Professioneller Flugsimulator mit erfahrenen Instruktoren - Abenteuer ohne Risiko.'
    },
    {
      icon: '🎯',
    ...
    },
    {
      ...
      description: 'Geschenkgutscheine ohne festes Datum - der Beschenkte wählt seinen Wunschtermin.'
    },
    {
      icon: '🌟',
      title: 'Premium Erlebnis',
      description: 'Hochmoderne Technik und erstklassiger Service für ein unvergessliches Erlebnis.'
    },
    {
      icon: '📸',
      ...
      <div className="container-section">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            6 Gründe, warum dieses Geschenk jeden begeistert
          </p>
        </motion.div>
